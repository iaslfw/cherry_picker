# Contributing to Cherry Picker

Thank you for your interest in contributing to Cherry Picker! I welcome all contributions, from bug reports to new features.
...
2. Clone the repository: `git clone https://github.com/pythonics/cherry_picker.git`
3. Install dependencies: `uv sync`

## Style Guidelines

- I use [Ruff](https://github.com/astral-sh/ruff) for linting and formatting. Run it with `ruff check` and `ruff format`.
